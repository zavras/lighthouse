...
import BFCacheErrors from '../../../gather/gatherers/bf-cache-errors.js';
...
describe('BFCacheErrors', () => {
  ...
  it('actively triggers bf cache in navigation mode', async () => {
    const gatherer = new BFCacheErrors();
  ...
  it('constructs a tree with no frame urls if no frame tree is provided', async () => {
    delete mockBfCacheEvent?.notRestoredExplanationsTree;
  ...
  it('constructs an empty structure if no event was found', async () => {
    mockBfCacheEvent = undefined;
